    ...
    <div className="bg-[#1a469d] flex items-center justify-center p-4 font-sans" 
      ...
      <div className="bg-[#1c3e89]/95 p-6 rounded-lg w-full max-w-[420px] shadow-2xl border border-blue-900/50">
        ...
        <div className="space-y-4">
          <button className="w-full bg-[#55da33] hover:bg-[#4bc12d] text-white text-4xl font-bold py-3 rounded-lg border-b-[6px] border-[#3e9d25] transition-all active:border-b-0 active:translate-y-[4px]">
            Play!
          </button>
          
          <button className="w-full bg-[#2b8ee4] hover:bg-[#257cc7] text-white text-xl font-bold py-3 rounded-lg border-b-[4px] border-[#1a5ea3] transition-all active:border-b-0 active:translate-y-[2px]">
            Create Private Room
          </button>
        </div>
